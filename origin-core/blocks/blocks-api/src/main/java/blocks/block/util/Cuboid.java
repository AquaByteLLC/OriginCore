 ...
 * @link <a href="https://www.spigotmc.org/threads/between-two-locations-cuboid.325266/#post-3045501">Adapted from</a>
 */
public class Cuboid {
    ...
    public int hashCode() {
        ...
        result = 92821 * result + minX;
        result = 92821 * result + minY;
        result = 92821 * result + minZ;
        result = 92821 * result + maxX;
        result = 92821 * result + maxY;
        result = 92821 * result + maxZ;
        return result;
    }
