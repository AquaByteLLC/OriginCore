...
public interface Messages {
	...
	TextComponent DOESNT_HAVE_ITEM_META = TextComponent.builder("The item doesn't have ItemMeta and cannot be modified!", TextColor.RED).build();
	TextComponent DOESNT_HAVE_REQUIRED_KEY = TextComponent.builder("This item isn't enchantable!", TextColor.RED).build();
